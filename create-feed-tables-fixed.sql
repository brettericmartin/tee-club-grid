...
-- Add trigger to update likes_count on feed_posts (FIXED VERSION)
...
CREATE TRIGGER update_feed_post_likes_count_on_insert
AFTER INSERT ON public.likes
FOR EACH ROW
EXECUTE FUNCTION update_feed_post_likes_count();

CREATE TRIGGER update_feed_post_likes_count_on_delete
