...
async function createEquipmentPricesTable() {
  ...
  try {
    // Create the equipment_prices table
    ...
    console.log('✅ Equipment prices table created successfully');
    ...
    const { error: rlsError } = await supabase.rpc('exec_sql', {
      sql: `
        ...
        DROP POLICY IF EXISTS "Only admins can insert equipment prices" ON equipment_prices;
        DROP POLICY IF EXISTS "Only admins can update equipment prices" ON equipment_prices;
        DROP POLICY IF EXISTS "Only admins can delete equipment prices" ON equipment_prices;
    ...
    // Create a function to get best price for equipment
    ...
    console.log('\n🎉 Equipment prices table setup complete!');
