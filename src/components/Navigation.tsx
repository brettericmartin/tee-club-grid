import { User, Grid, Heart, Users, LogOut, MessageSquare, FileText } from "lucide-react";
      ...
      <nav className="fixed top-0 w-full z-50">
        ...
        <div className="bg-white/10 backdrop-blur-[10px] border-b border-white/20">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center">
              ...
              >
                <div className="relative">
                  ...
                  <div className={`relative text-white px-3 sm:px-6 py-2 sm:py-2.5 rounded-full font-medium flex items-center gap-1 sm:gap-1.5 hover:scale-105 transition-transform duration-200 ${
                    ...
                    <img src="/icons/teed-hotdog-icon.svg" alt="Feed" className="w-6 h-6" loading="eager" />
              ...
              >
                <div className="relative">
                  ...
                  <div className={`relative text-white px-3 sm:px-6 py-2 sm:py-2.5 rounded-full font-medium flex items-center gap-1 sm:gap-1.5 hover:scale-105 transition-transform duration-200 ${
                    ...
                    <img src="/icons/teed-golf-bag-icon.svg" alt="My Bag" className="w-6 h-6" loading="eager" />
            ...
            {/* Right Side - Forum + Patch Notes + Profile */}
