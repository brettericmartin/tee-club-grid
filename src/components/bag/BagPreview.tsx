...
export function BagPreview({ isOpen, onClose, bag, equipment }: BagPreviewProps) {
  ...
  const categoryOrder = [
    ...
    'ball', 'bag', 'glove', 'rangefinder', 'gps', 'tee', 'towel',
    'ball_marker', 'divot_tool', 'accessories'
  ];
                  ...
                  return (
                    <div key={category}>
                      ...
                      <div className="space-y-2">
                        {items.map((item) => (
                          <div key={item.id} className="flex items-center gap-3 p-2 rounded hover:bg-[#1a1a1a] transition-colors">
