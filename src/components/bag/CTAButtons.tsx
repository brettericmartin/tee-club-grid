      ...
      <div className="bg-[#2a2a2a] border border-white/10 rounded-2xl p-8">
        <div className="text-center space-y-6">
          <motion.div
            ...
            className="inline-flex p-4 rounded-full bg-[#3a3a3a]"
          >
          ...
          <div className="space-y-2">
            ...
            <p className="text-emerald-200/70 max-w-md mx-auto">
              Join thousands of golfers showcasing their equipment and connecting
              with the community
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="relative z-10 space-y-3">
            ...
            <Button
              ...
              variant="outline"
              className="w-full bg-[#3a3a3a] border-white/10 text-white hover:bg-[#4a4a4a]"
            >
              {followLoading ? (
                "Loading..."
              ) : isFollowing ? (
        ...
        >
          <div className="relative z-10 space-y-3">
            ...
            <h4 className="text-lg font-semibold text-white">Compare Bags</h4>
            <p className="text-emerald-200/60 text-sm">
