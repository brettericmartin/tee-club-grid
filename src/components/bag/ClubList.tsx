  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "hover:border-emerald-400/20 hover:bg-emerald-500/10",
    ...
    >
      ...
      {/* Equipment Image */}
      <div className="flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden bg-emerald-900/20">
        {imageUrl && !imageError ? (
          <img
            src={imageUrl}
      ...
      <div className="flex-1 space-y-2">
        ...
        <div>
          ...
          {item.loft && (
            <span className="text-emerald-300/70 text-sm">{item.loft}°</span>
          )}
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Button
            size="sm"
            variant="ghost"
            className="text-emerald-300 hover:text-white hover:bg-emerald-700/20"
        ...
        {sortedCategories.map((category, index) => {
          ...
          return (
            ...
            >
              <AccordionItem
                value={category}
                className="border border-emerald-500/20 rounded-xl overflow-hidden bg-emerald-950/30 backdrop-blur-sm"
              >
                <AccordionTrigger className="px-4 py-3 hover:bg-emerald-500/5 hover:no-underline">
                  <div className="flex items-center justify-between w-full pr-2">
                    <div className="flex items-center gap-3">
                      ...
                      <Badge
                        variant="secondary"
                        className="bg-emerald-500/10 text-emerald-300 border-0"
                      >
                        {items.length}
                      </Badge>
                    </div>
