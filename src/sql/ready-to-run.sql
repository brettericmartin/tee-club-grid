...
-- This script is ready to copy and paste into Supabase SQL editor
...
BEGIN
  ...
  CREATE TEMP FUNCTION get_equipment_id_temp(p_brand TEXT, p_model TEXT, p_category TEXT)
  ...
  DROP FUNCTION get_equipment_id_temp(TEXT, TEXT, TEXT);
