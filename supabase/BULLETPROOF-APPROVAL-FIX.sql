-- ====================================================================
-- BULLETPROOF APPROVAL FIX - COMPLETELY BYPASS RLS
-- ====================================================================
...
-- Also, let's just disable RLS on profiles for service role operations
-- This ensures service role ALWAYS bypasses
CREATE POLICY IF NOT EXISTS "Service role bypasses everything" ON profiles
    AS PERMISSIVE
    FOR ALL
    TO service_role
    USING (true)
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '🔥 BULLETPROOF FIX APPLIED!';
    RAISE NOTICE '============================';
