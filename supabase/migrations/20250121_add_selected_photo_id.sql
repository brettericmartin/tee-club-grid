...
-- Note: custom_photo_url column is kept temporarily for migration and rollback safety
-- It will be removed in a future migration after successful migration and testing